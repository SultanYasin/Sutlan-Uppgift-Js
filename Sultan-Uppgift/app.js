...
function taskTwo() {
  ...
  /* ********  ***************  *************
  Jag har inte riktigt förståt om du ville att hela number arrayen ska renderas
   i diven eller bara den nylagda värden
...
function multiplier(valueOne, valueTwo) {
  if (typeof(valueOne) !== "number" || typeof(valueTwo) !== "number") {
    ...
    alert("produkt är : " + valueOne*valueTwo)
  }
}
...
function taskSeven() {
  ...
  let readyText = addMeSomeLineBreaks.replace(/,/ig ,"<br>");
  document.getElementById("answer-seven").innerHTML=readyText;
